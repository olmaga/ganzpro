...
const shows = [
  ...
  },
  {
    ...
    title: 'Die Nachwuchs-Ensemble Show: «HAROLD»',
    group: {
    ...
    description: {
      en: 'The stars of tomorrow, on stage today! The young ensemble performs the HAROLD – the original long-form from Chicago, woven from a single audience word.',
      de: 'Die Stars von morgen, schon heute auf der Bühne! Das Nachwuchs-Ensemble spielt den HAROLD – die Urform der Impro-Langformen aus Chicago, inspiriert von nur einem Wort aus dem Publikum.',
    },
    venue: 'töpferei',
