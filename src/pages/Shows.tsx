...
const shows = [
  ...
  },
  {
    ...
    description: {
      en: 'Zauber-Geschichten-Wander-Hut – Improv theater for & with kids.',
      de: 'Zauber-Geschichten-Wander-Hut – Impro-Theater für & mit Kindern.',
    },
    venue: 'Freilagerflohmi',
    address: 'Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Freilager+Zürich',
    ticketUrl: 'https://www.freilager.org',
  },
  {
    day: '09',
    month: 'May',
    ...
    description: {
      en: 'Spokes – A brief encounter. We discover how it came to be. Joint show with «da vorne links».',
      de: 'Spokes – Eine kurze Begegnung. Wir entdecken wie es dazu kam. Gemeinsame Show mit «da vorne links».',
    },
    venue: 'Theater Ida',
    address: 'Aargauerstrasse 80, Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+Ida+Aargauerstrasse+80+Zürich',
    ticketUrl: 'https://www.theaterida.ch',
  },
  {
    day: '10',
    month: 'May',
  ...
  },
  {
    ...
    description: {
      en: 'The duel of the improv teams. Two teams compete round by round in the challenges of improvisation.',
      de: 'Das Duell der Impro-Teams. Zwei Teams treten Runde für Runde in den Herausforderungen des Improvisierens gegeneinander an.',
    },
    venue: 'Theater im Zollhaus',
    address: 'Zollstrasse 121, 8005 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+im+Zollhaus+Zollstrasse+121+Zürich',
    ticketUrl: 'https://pfirsi.ch/impro-shows/theatersport-2026-09-05-20-00',
  },
  {
    day: '26',
    month: 'Sep',
    ...
    address: 'Zollstrasse 121, 8005 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+im+Zollhaus+Zollstrasse+121+Zürich',
    ticketUrl: 'https://pfirsi.ch/impro-shows/maestro-2026-09-26-20-00',
  },
  {
    day: '27',
    month: 'Sep',
    ...
    group: {
      name: 'zweierlei & LuckyLücke',
      instagram: 'https://instagram.com/zweierlei.impro',
      website: 'https://zweierlei-impro.ch',
    },
    description: {
      en: 'Two teams compete in the Ida Theatersport Liga – zweierlei against LuckyLücke.',
      de: 'Zwei Teams treten in der Ida Theatersport Liga gegeneinander an – zweierlei gegen LuckyLücke.',
    },
    venue: 'Theater Ida',
  ...
  },
  {
    ...
    ticketUrl: 'https://pfirsi.ch/impro-shows/die-nachwuchs-ensemble-show-harold-2026-10-05-19-30',
  },
  {
    day: '15',
    month: 'Oct',
  ...
  },
  {
    ...
    year: '2026',
    time: '19:30 Uhr',
    title: 'Ida Theatersport Liga (EN)',
    group: {
      name: 'LuckyLücke',
      instagram: '',
      website: '',
    ...
    description: {
      en: 'Theatersport in English at Theater Ida – I play with LuckyLücke.',
      de: 'Theatersport auf Englisch im Theater Ida – ich spiele mit LuckyLücke.',
    },
    venue: 'Theater Ida',
    address: 'Aargauerstrasse 80, 8048 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+Ida+Aargauerstrasse+80+Zürich',
  ...
  },
  {
    ...
    address: 'Töpferstrasse 26, 8045 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Töpferstrasse+26+8045+Zürich',
    ticketUrl: 'https://pfirsi.ch/impro-shows/die-nachwuchs-ensemble-show-harold-2026-11-02-19-30',
  },
  {
    day: '23',
    month: 'Nov',
    ...
    address: 'Töpferstrasse 26, 8045 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Töpferstrasse+26+8045+Zürich',
    ticketUrl: 'https://pfirsi.ch/impro-shows/die-nachwuchs-ensemble-show-harold-2026-11-23-19-30',
  },
  {
    day: '09',
    month: 'Dec',
    year: '2026',
    time: '20:00 Uhr',
    title: 'Geschichte trifft Impro IV',
    group: {
      name: 'Improlab',
      instagram: '',
      website: 'https://improlab.ch',
    },
    description: {
      en: 'Time travel with improv: historian Mike Stoll and Improlab mix gripping history talks with improv comedy.',
      de: 'Auf Zeitreise mit Impro: Mike Stoll und das Improlab mischen packende Geschichtsvorträge mit Impro-Comedy.',
    },
    venue: 'Sudhaus',
    address: 'Basel',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Sudhaus+Basel',
    ticketUrl: 'https://improlab.ch/events/improlab-show-2026-383-961-365/',
  },
  {
    day: '10',
    month: 'Dec',
    year: '2026',
    time: '20:00 Uhr',
    title: 'On Tour: Theatersport™ im Turbine Theater',
    group: {
      name: 'anundpfirsich',
      instagram: 'https://instagram.com/anundpfirsich',
      website: 'https://pfirsi.ch',
    ...
    description: {
      en: 'anundpfirsich on tour – Theatersport™ at the Turbine Theater.',
      de: 'anundpfirsich on Tour – Theatersport™ im Turbine Theater.',
    },
    venue: 'Turbine Theater',
    address: '',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Turbine+Theater',
    ticketUrl: 'https://pfirsi.ch/impro-shows/on-tour-theatersport-im-turbine-theater-2026-12-10-20-00',
  },
  {
    day: '14',
    month: 'Dec',
  ...
  },
  {
    ...
    description: {
      en: 'We play Theatersport in the Ida Theatersport Liga.',
      de: 'Wir spielen Theatersport in der Ida Theatersport Liga.',
    },
    venue: 'Theater Ida',
    address: 'Aargauerstrasse 80, 8048 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+Ida+Aargauerstrasse+80+Zürich',
  ...
  },
  {
    ...
    address: 'Zollstrasse 121, 8005 Zürich',
    mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Theater+im+Zollhaus+Zollstrasse+121+Zürich',
    ticketUrl: 'https://pfirsi.ch/impro-shows/maestro-2027-01-30-20-00',
  },
];
